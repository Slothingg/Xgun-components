<template>
  <div class="xg-media-box" :style="'background:'+backgroundUrl">
    <div class="xg-media-head">
      ...
      <div class="xg-media-head-user">
        <div class="username" :style="'color:'+ theme " @click.stop="toUser">
          {{item.username}}
        </div>
        <div class="time sub">
          {{item.time}}
      ...
      <div class="xg-media-head-buttom" @click.stop="follow">
        <div class="buttom" :style="(theme != '' ? 'background:'+ theme+';color:white' : '')"
          v-show="!item.already_follow">关注</div>
        <div class="buttom on" v-show="item.already_follow">已关注</div>
      </div>
    </div>
    ...
    <div class="xg-media-foot" v-if="!order_tools" :style="'color:'+ theme ">
      ...
      <div class="tools" @click.stop="chat">
      ...
      <div class="tools" @click.stop="share">
